...
class MmParser:
    ...
    def __init__(self, minimoon_file_path, top_directory, dest_directory):
        """
        Constructor
        :param minimoon_file: Takes the file path that contains the names of all files that represent minimoons
    ...
    def mm_file_parse(self, file_path):
        """
        This function parses a single minimoon file into a appropriately labelled dataframe
        :return:
...
if __name__ == '__main__':
    ...
    for id in mm_parser.mm_data["File Name"]:
        ...
        ax.plot3D(data["Geo x"], data["Geo y"], data["Geo z"], 'green', linewidth=5)
        plt.show()
