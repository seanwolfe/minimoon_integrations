...
class MainWindow(QMainWindow):
    ...
    def create_parser_windows(self):
        ...
        mm_master_file_name = 'minimoon_master_final.csv'  # name of the minimoon file to parsed
    ...
    def create_21(self, retrograde_pop, prograde_pop):
        ...
        self.fig_21.axes.hist(retrograde_pop['Capture Duration'], bins=1000, label='Retrograde', edgecolor="#038cfc", color="#03b1fc")
        self.fig_21.axes.hist(prograde_pop['Capture Duration'], bins=1000, label='Prograde', edgecolor="#ed0000", color="#f54747")
    ...
    def create_22(self, retrograde_pop, prograde_pop):
        ...
        self.fig_22.axes.hist(abs(retrograde_pop['Number of Rev']), bins=350*20, label='Retrograde', edgecolor="#038cfc", color="#03b1fc")
        self.fig_22.axes.hist(abs(prograde_pop['Number of Rev']), bins=350*20, label='Prograde', edgecolor="#ed0000", color="#f54747")
    ...
    def create_31(self, master):
        ...
        self.fig_31.axes.scatter(master['Geo x at Capture'], master['Geo y at Capture'], s=0.1)
    ...
    def create_32(self, master):
        ...
        self.fig_32.axes.scatter(trans_xyz[0, :], trans_xyz[1, :], s=0.1)
        self.fig_32.axes.set_xlim([-0.03, 0.03])
        c1 = plt.Circle((0, 0), radius=0.01, alpha=0.1)
    ...
    def create_41(self, master):
        ...
        self.fig_41.axes.scatter(master['Capture Duration'], master['Min. Distance'], color='blue', label='Minimum', s=1)
        self.fig_41.axes.scatter(master['Capture Duration'], master['Max. Distance'], color='red', label='Maximum', s=1)
    ...
    def create_42(self, master):
        ...
        self.fig_42.axes.scatter(master['Capture Duration'], d, color='blue', s=1)
    ...
    def create_51(self, retrograde_pop, prograde_pop, tco_pop):
        ...
        self.fig_51.axes.scatter(tco1_retro['Capture Duration'], abs(tco1_retro['Number of Rev']), color='blue',
                    label='TCO I (Retrograde)', s=4.)
        self.fig_51.axes.scatter(tco1_pro['Capture Duration'], abs(tco1_pro['Number of Rev']), color='brown', label='TCO I (Prograde)', s=4.)
        self.fig_51.axes.scatter(tco2a['Capture Duration'], abs(tco2a['Number of Rev']), color='yellow', label='TCO IIA', s=4.)
        self.fig_51.axes.scatter(tco2b['Capture Duration'], abs(tco2b['Number of Rev']), color='green', label='TCO IIB', s=20.)
    ...
    def create_52(self, tco_pop):
        self.fig_52.axes.scatter(tco_pop["X at Earth Hill"], tco_pop["Y at Earth Hill"], s=0.1)
        c1 = plt.Circle((0, 0), radius=0.01, alpha=0.1)
